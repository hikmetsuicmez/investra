...
public class TradeOrderController implements TradeOrderApiDocs {
    ...
    public ResponseEntity<Response<List<TradeOrderDTO>>> getAllOrders(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<Response<List<TradeOrderDTO>>> getPendingOrders(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<Response<List<TradeOrderDTO>>> getExecutedOrders(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<Response<List<TradeOrderDTO>>> getSettledOrders(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<Response<List<TradeOrderDTO>>> getCancelledOrders(@AuthenticationPrincipal UserDetails userDetails) {
