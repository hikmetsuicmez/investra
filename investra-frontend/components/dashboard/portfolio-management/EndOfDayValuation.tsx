				...
				<div className="bg-white rounded-xl shadow overflow-auto border">
					...
					{valuations.map((v) => (
						<div key={v.clientId} className="grid grid-cols-5 items-center p-4 hover:bg-gray-50 transition border-t">
							...
							<div className={v.unrealizedProfitLoss >= 0 ? "text-green-600" : "text-red-600"}>
								{v.unrealizedProfitLoss.toLocaleString("tr-TR", { style: "currency", currency: "TRY" })}
							</div>
					...
					<AlertDialog>
						...
						<AlertDialogContent>
							<AlertDialogHeader>
								...
								<AlertDialogDescription>
									Bu işlem tarihi bir gün ilerletecek ve tüm müşteriler için portföyleri yeniden değerlendirecektir.
