...
export default function AccountInformation() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 bg-gray-50 min-h-screen relative">
      ...
      {error && (
        <p className="text-red-500 text-center p-4 bg-red-100 rounded-md">
          {error}
        </p>
      )}
          ...
          <Card>
            ...
            <CardContent>
              <dl className="space-y-2">
                ...
                <InfoRow
                  label="Kurum Hesap No"
                  value={account.accountNumberAtBroker}
                />
                <InfoRow
                  label="Saklamacı Kurum"
