        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>Hesap Tipi <span className="text-red-500">*</span></Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>Aracı Kurum Adı <span className="text-red-500">*</span></Label>
                <Input
              ...
              <div>
                <Label>Aracı Kurum Kodu <span className="text-red-500">*</span></Label>
                <Input
                  placeholder="Örn: 123"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>Saklama Kurumu Adı <span className="text-red-500">*</span></Label>
                <Input
              ...
              <div>
                <Label>Saklama Kurumu Kodu <span className="text-red-500">*</span></Label>
                <Input
                  placeholder="Örn: 456"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label>IBAN No <span className="text-red-500">*</span></Label>
                <Input
              ...
              <div>
                <Label>Hesap No <span className="text-red-500">*</span></Label>
                <Input
